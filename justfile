...
gen-models-dev-pricing:
    snapshots="$(nix build .#models-dev-pricing --no-link --print-out-paths)" && cp "$snapshots/models-dev-pricing.json" rust/crates/ccusage-core/src/models-dev-pricing.json && cp "$snapshots/models-dev-provider-trust.json" rust/crates/ccusage-core/src/models-dev-provider-trust.json && cp "$snapshots/codex-auto-review-fallbacks.json" rust/adapters/codex/src/codex-auto-review-fallbacks.json
    chmod u+w rust/crates/ccusage-core/src/models-dev-pricing.json
    chmod u+w rust/crates/ccusage-core/src/models-dev-provider-trust.json
    ...
    nix fmt rust/crates/ccusage-core/src/models-dev-provider-trust.json
